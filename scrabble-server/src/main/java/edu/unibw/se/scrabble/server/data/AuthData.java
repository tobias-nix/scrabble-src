...
public interface AuthData {
     ...
     * e.g. if the username or the password is empty or null
     * or the length of the username is less than 4 or longer than 8 characters
     * or the username is already in database
