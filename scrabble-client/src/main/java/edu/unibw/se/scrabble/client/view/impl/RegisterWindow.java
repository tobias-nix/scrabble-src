...
public class RegisterWindow extends Stage {
...

    {
        ...
        vBox.getChildren().addAll(heading, hBoxT, registerButton);

        setScene(new Scene(vBox));
    }

    public RegisterWindow(FxView mainView) {
        ...
        registerButton.setOnAction((event) -> {
            ...
            if (message != null) {
                ...
                if (message != null) {
                    ...
                    ReturnValues.ReturnRegisterUser result = ViewControl.clientConnect.registerUser(userName, password);
                    if (result != ReturnValues.ReturnRegisterUser.SUCCESSFUL) {
    ...
    private String getErrorMessageFromServer(ReturnValues.ReturnRegisterUser result) {
        return switch (result) {
            case USERNAME_ALREADY_EXISTS -> "USERNAME_ALREADY_EXISTS: This name is already taken";
