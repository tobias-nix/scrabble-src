...
public class ReturnValues {
    ...
    public enum ReturnLoginUser {
        NETWORK_FAILURE, DATABASE_FAILURE, USERNAME_NOT_IN_DATABASE, WRONG_PASSWORD, DATA_FORMAT_FAILURE, SUCCESSFUL, FAILURE
    }

    public enum ReturnRegisterUser {
        NETWORK_FAILURE, DATABASE_FAILURE, USERNAME_ALREADY_EXISTS, DATA_FORMAT_FAILURE, SUCCESSFUL, FAILURE
    }
